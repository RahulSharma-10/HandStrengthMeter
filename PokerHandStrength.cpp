...
double HandStrengthCalc(int type, vector<int> extra)
{
    ...
    switch(type){
        ...
        case 2: //Straight-Flush
            {
           val= 110 + (extra[0]-5); //{Top=6, A= 14}, 108 
            break;
            }
        case 3: //Four of a Kind
            {
           val= 96 + (extra[0]-2); //{Top= 2, 14} [85, 97]
            break;
            }
        case 4: //Full House
            {
           val= 83 + (extra[0]-2); //{Top=2, 14} [72, 84]
            break;
            }
        case 5:  //Flush
            {
        ...
        case 8: //Two Pair -> (1stP, 2nd P, Side)
            {
            val = 39;
            double multi = 1;
...
{
    func1();
    vector<string> hand= {"Jc", "Tc"};  
    
    vector<string> flop = {"Ac", "Kc", "Qc", "9c", "6c"};
    
    // hand= {Jc, 10c} 
    
    pdd score= analyse(flop, 2);
